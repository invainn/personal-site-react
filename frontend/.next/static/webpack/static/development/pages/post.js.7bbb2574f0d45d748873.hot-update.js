      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            id = query.id;
            _context.next = 4;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_14___default()(process.env.SITE_URL ? "".concat(process.env.SITE_URL, "/posts/").concat(id) : 'http://localhost:1337/posts/${id}');
...
//# sourceMappingURL=post.js.7bbb2574f0d45d748873.hot-update.js.map